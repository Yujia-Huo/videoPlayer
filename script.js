...
d3.csv("./data/Joker_camera_movement.csv").then(function (data) {
...
function seektimeupdate() {
  ...
  d3.csv("./data/joker_shot_data.csv").then(function (sceneData) {
...
function drawVisualization() {
  ...
  svg
    ...
    .attr("xlink:href", "./joker_combined_sorted_image.png") // The path to your PNG image
  ...
  Promise.all([
    d3.csv("./data/joker_shot_data.csv"), // Load scene data
    d3.csv("./data/Joker_shot_type.csv"), // Load shot type data
